<?php
	...
	$pwd_checked = !empty($_POST['confirm_pw']) ? $_POST['confirm_pw'] : NULL;
    ...
    if(isset($_POST["signup"])){
		...
		else
		{
			...
			$objPdo->query("INSERT INTO user (rowid, login, password, lastname) VALUES (NULL, '".$login."', '".$password."', '".$lastname."');");
    ...
    <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            ...
            <div class="account-wall">
				...
				<label class="checkbox pull-left">
					<input type="checkbox" name="confirm_pw">
						Confirm Password
				</label>
				
				
                <button name="signup" class="btn btn-lg btn-primary btn-block" type="submit">
                    Sign in
				</button>
                </form>
            </div>
